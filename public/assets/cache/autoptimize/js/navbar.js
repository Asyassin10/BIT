...
if (hhref.includes("service/construire-la-vision#architecture")) {
    let element = document.getElementById(
        "construire_la_vision__architecture_title"
    );
    element.classList.add("color_gold");
}
if (hhref.includes("accompagner-la-mise-en-oeuvre#pilotage.")) {
    let element = document.getElementById(
        "accompagner_la_mise_en_oeuvre__Pilotage_title"
    );
    element.classList.add("color_gold");
}
if (hhref.includes("service/accompagner-la-mise-en-oeuvre#r%C3%A9alisation.")) {
    let element = document.getElementById(
