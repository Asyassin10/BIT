...
$(function () {
    ...
    let js_data = [
        {
            ...
            name: "edit articles",
            guard_name: "web",
            created_at: "2023-05-02T10:29:15.000000Z",
            updated_at: "2023-05-02T10:29:15.000000Z",
        },
        {
            id: 4,
        ...
        },
        {
            ...
            name: "role 012",
            guard_name: "web",
            created_at: "2023-05-03T10:23:55.000000Z",
            updated_at: "2023-05-03T10:23:55.000000Z",
        },
    ];
    ...
    if (dataTablePermissions.length) {
        dt_permission = dataTablePermissions.DataTable({
            data: js_data,
            // JSON file to add data assetPath + "data/permissions-list.json"
            /* columns: [
