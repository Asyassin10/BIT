...
@section('body')
    ...
    <body
                ...
                <div class="container-fluid m-0 p-0">
                    <div data-elementor-type="single-page" data-elementor-id="7230"
                        ...
                        <section
                            ...
                            id="has_ae_slider_app_style" {{-- style="margin-bottom: -250px;" --}} data-id="24d79048"
                            data-element_type="section">
                            <div class="elementor-container elementor-column-gap-no mb-0 mb-md-4 "style="">
                    ...
                    <section style="width: 100%;" class="mt-50 mt-sm-25">
                        <div class="elementor-container elementor-column-gap-no bg-dark text-white "
                            style="height:20%;margin-top:350px;">

                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('images/webp/Construire-la-vision.webp') }}" width="50%"
                                    class="app_header_img" style="">
                            </div>
                            <br>
                            <br>
                            <br>
                            <p class="w-75" style="font-size: 20px;margin-left:10%;padding-bottom: 450px;">
                        ...
                        <div style="width: 75%;margin-top:-360px;" class="mx-auto shadow bg-white rounded">
                            <br>
                            <p class=" h2 pt-4" style="margin-left: 8%;">
                            ...
                            <br>
                            <br>
                            <div class="d-flex justify-content-center w-75" {{-- style="text-align: left;" --}}
                                style="margin-left: 8%;margin-top: 2%;">
                                <button style="background: #DE9E3C;border:none;" class="p-3 text-dark">
                                    Contacter un expert
                                </button>
                            </div>
                            <br>
                        ...
                        <div style="width: 75%;margin-top:140px;" class="mx-auto shadow bg-white rounded">
                            <br>
                            <p class=" h2 pt-4" style="margin-left: 8%;">
                                Architecture
                            </p>
                        ...
                        <div style="margin-top:140px;z-index: 1;position: relative;" id="form_container"
                            class=" shadow  bg-white rounded">
                            <br>
                            <p class=" h4  pt-4" style="margin-left: 8%;">
                                Construisons votre vision ensemble
                            </p>
                            <div class="mb-3 " style="margin-left: 8%;margin-right: 8%;margin-top: 3%;">
                            ...
                            <div class="mb-3 " style="margin-left: 8%;margin-right: 8%;margin-top: 3%;">
                                ...
                                <select class="form-select  " style="background: #F5F5F5 !important;">
                                    <option style="background: #F5F5F5 !important;">Open this select menu</option>
                            ...
                            <style>
                                #select2-3gt0-container {
                                    background: red;
                                }
                            </style>
                            <div class="mb-3" style="margin-left: 8%;margin-right: 8%;margin-top: 3%;">
                                <label for="exampleFormControlTextarea1" class="form-label">Example textarea</label>
                                <textarea class="form-control" style="background:#F5F5F5;height:300px" id="exampleFormControlTextarea1"
                                    rows="2" cols="500"></textarea>
                            </div>
                            ...
                            <br>
                            <br>
                            <div class="d-flex justify-content-end" style="margin-right: 8%;" {{-- style="text-align: left;" --}}
                                style="margin-left: 8%;margin-top: 2%;">
                                <button style="background: #DE9E3C;border:none;" class="px-3 py-2 text-dark">
                                    Envoyer
                                </button>
                            </div>
                            <br>
                        ...
                        <div style="width: 100%;margin-top:-870px;height:1100px;" class=" shadow  bg-dark rounded">
                            <div class="svg-container">

                                <img src="{{ asset('images/webp/ss.webp') }}" alt="" srcset=""
                    ...
                    {{--  <section style="width: 75%;margin-top:-80px;" class="mx-auto shadow bg-white">
                    ...
                    {{-- <div data-elementor-type="single-page" data-elementor-id="7230"
                            ...
                            <section
                                class="has_ae_slider elementor-section elementor-top-section elementor-element elementor-element-24d79048 elementor-section-content-bottom elementor-section-boxed elementor-section-height-default elementor-section-height-default ae-bg-gallery-type-default"
                                data-id="24d79048" data-element_type="section">
                                <div class="elementor-container elementor-column-gap-no">
                                    <div class="has_ae_slider elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-229138f1 ae-bg-gallery-type-default"
                                        data-id="229138f1" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-3dfbbae elementor-widget elementor-widget-heading"
                                    ...
                                    <div class="has_ae_slider elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-7a01a210 ae-bg-gallery-type-default"
                                        data-id="7a01a210" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-4104dd20 elementor-widget elementor-widget-image"
                                                data-id="4104dd20" data-element_type="widget"
                            ...
                            <section
                                class="has_ae_slider elementor-section elementor-top-section elementor-element elementor-element-12911709 elementor-section-content-middle elementor-section-boxed elementor-section-height-default elementor-section-height-default ae-bg-gallery-type-default"
                                data-id="12911709" data-element_type="section">
                                <div class="elementor-container elementor-column-gap-no">
                                    <div class="has_ae_slider elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-56c685b5 ae-bg-gallery-type-default"
                                        data-id="56c685b5" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-ce96803 elementor-widget elementor-widget-heading"
                                            ...
                                            <div class="elementor-element elementor-element-599aeefd elementor-widget elementor-widget-text-editor"
                                                data-id="599aeefd" data-element_type="widget"
                                    ...
                                    <div class="has_ae_slider elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-5514355e ae-bg-gallery-type-default"
                                        data-id="5514355e" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-1bf85428 elementor-widget elementor-widget-image"
                            ...
                            <section
                                class="has_ae_slider elementor-section elementor-top-section elementor-element elementor-element-4974415a elementor-section-boxed elementor-section-height-default elementor-section-height-default ae-bg-gallery-type-default"
                                data-id="4974415a" data-element_type="section" id="services-acc">
                                <div class="elementor-container elementor-column-gap-no">
                                    <div class="has_ae_slider elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-7891007 ae-bg-gallery-type-default"
                                        data-id="7891007" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-5e286f72 services-accordeon elementor-widget elementor-widget-ae-post-blocks-adv"
                                                data-id="5e286f72" data-element_type="widget"
                                                    ...
                                                    <div class="ae-outer-wrapper ae-height-100">
                                                        ...
                                                        <div class="ae-post-collection elementor-accordion ae-accordion"
                                                            ...
                                                            <div class="ae-accordion-item">
                                                                <h6 id="ae-tab-title-35043185451" t_id="35043185451"
                                                                    class="ae-tab-title ae-post-blocks-adv-accordion ae-active"
                                                                    data-tab="1" role="tab"
                                                                    aria-controls="ae-tab-content-35043185451">
                                                                    <span class="ae-accordion-icon ae-accordion-icon-right"
                                                                        aria-hidden="true">
                                                                        <span class="ae-accordion-icon-closed">
                                                                            <svg
                                                                        ...
                                                                        <span class="ae-accordion-icon-opened">
                                                                            <svg
                                                                                xmlns="http://www.w3.org/2000/svg"
                                                                                width="36" height="36"
                                                                                viewBox="0 0 36 36">
                                                                    ...
                                                                    <a href="#">{!! $articles[4]->article_text !!}
                                                                    </a>
                                                                </h6>
                                                                <div id="ae-tab-content-35043185451" t_id="35043185451"
                                                                    ...
                                                                    aria-labelledby="ae-tab-title-35043185451">

                                                                    <article class="ae-post-item ae-post-item-5e286f72">
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div class="elementor-element elementor-element-99cfddb elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                                                                                                                        ...
                                                                                                                                                        <div
                                                                                                                                                            class="elementor-widget-container">
                                                                                                                                                            <span
                                                                                                                                                                class="elementor-heading-title elementor-size-default">{!! $articles[5]->article_text !!}</span>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div class="elementor-element elementor-element-99cfddb elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                                                                                                                        ...
                                                                                                                                                        <div
                                                                                                                                                            class="elementor-widget-container">
                                                                                                                                                            <span
                                                                                                                                                                class="elementor-heading-title elementor-size-default">{!! $articles[7]->article_text !!}</span>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div class="elementor-element elementor-element-99cfddb elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                                                                                                                        ...
                                                                                                                                                        <div
                                                                                                                                                            class="elementor-widget-container">
                                                                                                                                                            <span
                                                                                                                                                                class="elementor-heading-title elementor-size-default">{!! $articles[6]->article_text !!}</span>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                            ...
                                                            <div class="ae-accordion-item">
                                                                <h6 id="ae-tab-title-35043185452" t_id="35043185452"
                                                                    class="ae-tab-title ae-post-blocks-adv-accordion"
                                                                    data-tab="2" role="tab"
                                                                    aria-controls="ae-tab-content-35043185452">
                                                                    <span class="ae-accordion-icon ae-accordion-icon-right"
                                                                        aria-hidden="true">
                                                                    ...
                                                                    <a href="#">{!! $articles[9]->article_text !!}</a>
                                                                </h6>
                                                                <div id="ae-tab-content-35043185452" t_id="35043185452"
                                                                    class="elementor-clearfix ae-tab-content ae-post-blocks-adv-accordion"
                                                                    data-tab="2" role="tabpanel"
                                                                    aria-labelledby="ae-tab-title-35043185452">
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div class="elementor-element elementor-element-99cfddb elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                                                                                                                        ...
                                                                                                                                                        <div
                                                                                                                                                            class="elementor-widget-container">
                                                                                                                                                            <span
                                                                                                                                                                class="elementor-heading-title elementor-size-default">{!! $articles[11]->article_text !!}</span>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div class="elementor-element elementor-element-99cfddb elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                                                                                                                        ...
                                                                                                                                                        <div
                                                                                                                                                            class="elementor-widget-container">
                                                                                                                                                            <span
                                                                                                                                                                class="elementor-heading-title elementor-size-default">{!! $articles[12]->article_text !!}</span>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                            ...
                                                            <div class="ae-accordion-item">
                                                                <h6 id="ae-tab-title-35043185453" t_id="35043185453"
                                                                    class="ae-tab-title ae-post-blocks-adv-accordion"
                                                                    data-tab="3" role="tab"
                                                                    aria-controls="ae-tab-content-35043185453">
                                                                    <span class="ae-accordion-icon ae-accordion-icon-right"
                                                                        aria-hidden="true">
                                                                        <span class="ae-accordion-icon-closed"><svg
                                                                                xmlns="http://www.w3.org/2000/svg"
                                                                    ...
                                                                    <a href="#">{!! $articles[14]->article_text !!} </a>
                                                                </h6>
                                                                <div id="ae-tab-content-35043185453" t_id="35043185453"
                                                                    class="elementor-clearfix ae-tab-content ae-post-blocks-adv-accordion"
                                                                    data-tab="3" role="tabpanel"
                                                                    aria-labelledby="ae-tab-title-35043185453">
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div class="elementor-element elementor-element-99cfddb elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                                                                                                                        ...
                                                                                                                                                        <div
                                                                                                                                                            class="elementor-widget-container">
                                                                                                                                                            <span
                                                                                                                                                                class="elementor-heading-title elementor-size-default">{!! $articles[16]->article_text !!}</span>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div class="elementor-element elementor-element-99cfddb elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                                                                                                                        ...
                                                                                                                                                        <div
                                                                                                                                                            class="elementor-widget-container">
                                                                                                                                                            <span
                                                                                                                                                                class="elementor-heading-title elementor-size-default">{!! $articles[17]->article_text !!}</span>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                            ...
                                                            <div class="ae-accordion-item">
                                                                <h6 id="ae-tab-title-35043185454" t_id="35043185454"
                                                                    class="ae-tab-title ae-post-blocks-adv-accordion"
                                                                    data-tab="4" role="tab"
                                                                    ...
                                                                    <a href="#">{!! $articles[19]->article_text !!}</a>
                                                                </h6>
                                                                <div id="ae-tab-content-35043185454" t_id="35043185454"
                                                                    class="elementor-clearfix ae-tab-content ae-post-blocks-adv-accordion"
                                                                    data-tab="4" role="tabpanel"
                                                                    aria-labelledby="ae-tab-title-35043185454">
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div class="elementor-element elementor-element-99cfddb elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                                                                                                                        ...
                                                                                                                                                        <div
                                                                                                                                                            class="elementor-widget-container">
                                                                                                                                                            <span
                                                                                                                                                                class="elementor-heading-title elementor-size-default">{!! $articles[21]->article_text !!}</span>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div class="elementor-element elementor-element-99cfddb elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                                                                                                                        ...
                                                                                                                                                        <div
                                                                                                                                                            class="elementor-widget-container">
                                                                                                                                                            <span
                                                                                                                                                                class="elementor-heading-title elementor-size-default">{!! $articles[22]->article_text !!}</span>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                            ...
                            <section
                                class="has_ae_slider elementor-section elementor-top-section elementor-element elementor-element-647e5c23 elementor-section-full_width elementor-section-content-middle elementor-section-height-default elementor-section-height-default ae-bg-gallery-type-default"
                                data-id="647e5c23" data-element_type="section"
                                data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                <div class="elementor-container elementor-column-gap-no">
                                    <div class="has_ae_slider elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-539f46ce ae-bg-gallery-type-default"
                                        data-id="539f46ce" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <section
                                                class="has_ae_slider elementor-section elementor-inner-section elementor-element elementor-element-3ea1aa34 elementor-section-content-middle elementor-section-boxed elementor-section-height-default elementor-section-height-default ae-bg-gallery-type-default"
                                                data-id="3ea1aa34" data-element_type="section">
                                                <div class="elementor-container elementor-column-gap-no">
                                                    <div class="has_ae_slider elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-7b25d73a ae-bg-gallery-type-default"
                                                        data-id="7b25d73a" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <div class="elementor-element elementor-element-1e0bdc0e elementor-widget elementor-widget-heading"
                                                                data-id="1e0bdc0e" data-element_type="widget"
                                                                data-widget_type="heading.default">
                                                                <div class="elementor-widget-container">
                                                                    <h2
                                                                        class="elementor-heading-title elementor-size-default">
                                                                        {!! $articles[24]->article_text !!}</h2>
                                                                </div>
                                                            </div>
                                                            <div class="elementor-element elementor-element-a754f1e elementor-widget elementor-widget-text-editor"
                                                                data-id="a754f1e" data-element_type="widget"
                                                                data-widget_type="text-editor.default">
                                                                <div class="elementor-widget-container">
                                                                    <p>{!! $articles[25]->article_text !!}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <section
                                                                class="has_ae_slider elementor-section elementor-inner-section elementor-element elementor-element-1cb55a18 elementor-section-boxed elementor-section-height-default elementor-section-height-default ae-bg-gallery-type-default"
                                                                data-id="1cb55a18" data-element_type="section">
                                                                <div
                                                                    class="elementor-container elementor-column-gap-default">
                                                                    <div class="has_ae_slider elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-76d9ce93 ae-bg-gallery-type-default"
                                                                        data-id="76d9ce93" data-element_type="column">
                                                                        <div
                                                                            class="elementor-widget-wrap elementor-element-populated">
                                                                            <div class="elementor-element elementor-element-6a282957 elementor-align-left elementor-widget__width-auto elementor-widget elementor-widget-button"
                                                                                data-id="6a282957"
                                                                                data-element_type="widget"
                                                                                data-widget_type="button.default">
                                                                                <div class="elementor-widget-container">
                                                                            ...
                                                                            <div class="elementor-element elementor-element-215ec25 elementor-align-left elementor-widget__width-auto elementor-widget elementor-widget-button"
                                                                                data-id="215ec25"
                                                                                data-element_type="widget"
                                                                                data-widget_type="button.default">
                                                                                <div class="elementor-widget-container">
                                                                            ...
                                                                            <div class="elementor-element elementor-element-1e8ebe1 elementor-align-left elementor-widget__width-auto elementor-widget elementor-widget-button"
                                                                                data-id="1e8ebe1"
                                                                                data-element_type="widget"
                                                                                data-widget_type="button.default">
                                                                                <div class="elementor-widget-container">
                                                                            ...
                                                                            <div class="elementor-element elementor-element-7bda6bd3 elementor-align-left elementor-widget__width-auto elementor-widget elementor-widget-button"
                                                                                data-id="7bda6bd3"
                                                                                data-element_type="widget"
                                                                                data-widget_type="button.default">
                                                                                <div class="elementor-widget-container">
                                                    ...
                                                    <div class="has_ae_slider elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-57a60b62 ae-bg-gallery-type-default"
                                                        data-id="57a60b62" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <div class="elementor-element elementor-element-29ec4bf0 elementor-widget elementor-widget-stm_charts"
                                                                data-id="29ec4bf0" data-element_type="widget"
                                                                data-widget_type="stm_charts.default">
                                                                <div class="elementor-widget-container">
                                                                    <div
                                                                        class="stm_chart stm_charts legend_position_bottom">
                                                                        <canvas id="chart_64131d799b90b" width="380"
                                                                            height="480"></canvas>
                                                                        <script type="text/javascript">
                                                                            jQuery(window).on('load', function($) {
                                                                                var showLegend = false;
                                                                                var ChartData_chart_64131d799b90b = {
                                                                                    "datasets": [{
                                                                                        "label": "My First Dataset",
                                                                                        "data": ["35", "30", "15", "20"],
                                                                                        "backgroundColor": ["rgba(19, 92, 253, 0.75)", "rgba(233, 155, 23, 0.75)",
                                                                                            "rgba(255, 255, 255, 0.75)", "rgba(60, 237, 183, 0.75)"
                                                                                        ]
                                                                                    }],
                                                                                    "labels": ["Multi-Speed IT", "Transformation des produits IT", "Transformation UX",
                                                                                        "Technologie et Innovation"
                                                                                    ]
                                                                                };
                                                                                var chart_64131d799b90b = jQuery("#chart_64131d799b90b").get(0).getContext("2d");
                                                                                chart_64131d799b90b.
                                                                                canvas.width = 380;
                                                                                chart_64131d799b90b.
                                                                                canvas.height = 480;

                                                                                var stackedLine = new Chart(chart_64131d799b90b, {
                                                                                    type: 'doughnut',
                                                                                    data: ChartData_chart_64131d799b90b,
                                                                                    options: {
                                                                                        'legend': {
                                                                                            'position': 'bottom',
                                                                                            'display': showLegend
                            ...
                            <section
                                class="has_ae_slider elementor-section elementor-top-section elementor-element elementor-element-27fe4cf5 elementor-section-full_width elementor-section-height-default elementor-section-height-default ae-bg-gallery-type-default"
                                data-id="27fe4cf5" data-element_type="section"
                                data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                <div class="elementor-container elementor-column-gap-no">
                                    <div class="has_ae_slider elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-cae1e58 ae-bg-gallery-type-default"
                                        data-id="cae1e58" data-element_type="column">
                                        <div class="elementor-widget-wrap elementor-element-populated">
                                            <div class="elementor-element elementor-element-1f98ce95 elementor-widget elementor-widget-spacer"
                                                data-id="1f98ce95" data-element_type="widget"
                                            ...
                                            <div class="elementor-element elementor-element-13ff4bfd elementor-widget elementor-widget-heading"
                                                data-id="13ff4bfd" data-element_type="widget"
                                                data-widget_type="heading.default">
                                                <div class="elementor-widget-container">
                                                    <h6 class="elementor-heading-title elementor-size-default">
                                            ...
                                            <div class="elementor-element elementor-element-1abc2a8c elementor-widget elementor-widget-heading"
                                            ...
                                            <div class="elementor-element elementor-element-2435b820 elementor-widget elementor-widget-text-editor"
                                                data-id="2435b820" data-element_type="widget"
                                                data-widget_type="text-editor.default">
                                                <div class="elementor-widget-container">
                                                    <p>{!! $articles[32]->article_text !!}
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="elementor-element elementor-element-61e15a5 elementor-align-center elementor-widget elementor-widget-button"
                                                data-id="61e15a5" data-element_type="widget"
                                                data-widget_type="button.default">
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-button-wrapper icon_align_right  ">
        ...
        {{--    <link rel='stylesheet' id='elementor-post-5189-css'
            href='../wp-content/cache/autoptimize/css/autoptimize_single_94e07ddcd6987391f98022c3058eae11.css@ver=1675955141.css'
