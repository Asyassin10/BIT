                    ...
                    <section style="width: 100%;heigt:10%;" id=""
                        ...
                        <div class="app_d_v_header_container  mx-0 px-0 row w-100 d-flex align-items-center tout_nos_services_container"
                            ...
                            <div class=" col-12 col-md-7 tout_nos_services_child_a" id="">
                                ...
                                <p style="text-align:left;margin-left: 10%;margin-right: 10%;width:80%;">
                                    Accompagnement à la maîtrise d’ouvrage de plusieurs tableaux de bords pour le pôle
                                    Finance et SIR. </p>
                            </div>
                            <div class="col-12 col-md-5 study_cases_image_header m-0 p-0" id="">
                                <img src="{{ secure_asset('images/blogimage/Randstad.webp') }}" class="m-0 p-0 w-100">
                            ...
                            <div
                                ...
                                <div class="w-100 w-md-50  content_centered">
                                    ...
                                    <p class="text-left my-4 " style="padding-top: 3%;">
                                        Randstad est un groupe d’entreprises néerlandaises spécialisé dans le domaine de
                                        l’intérim et des services en ressources humaines. Dans le but d’améliorer sa
                                        connaissance des ressources humaines et d’optimiser ses processus, Randstad a
                                        souhaité mettre en place des outils d’aide à la décision afin d’optimiser ses
                                        processus RH, tels que la détection de candidatures, la recherche de formations et
                                        l’identification de potentiels employeurs. Ces outils reposent sur l’analyse d’un
                                        grand volume de données et mettent l’accent sur les compétences et l’ancrage
                                        territorial des individus.
                                    </p>
                                    <p class="text-left mt-2">
                                        Nous avons accompagné le projet depuis sa conception jusqu’à la mise en place de
                                        trois principales briques de Business Intelligence (BI) : l’architecture
                                        décisionnelle de la base de données, l’ETL (Extract, Transform, Load) et le module
                                        de reporting basé sur Tableau Software.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class=" row   tout_nos_services_container " id=""
                            ...
                            <div class="col-md-9 div_content_container">
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Gestion des dossiers individuels, facturation clients-fournisseurs
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Dimension produits (famille, sous-famille, services)
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Dimension temporelle (année, semestre, mois)
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Gestion de la paie (planning, présence, écritures comptables, etc.)
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="bg_white_content_container">
                                    <p class="bg_white_content_header h4">
                                        Gestion du projet et conception</p>
                                    <div class="d-flex align-items-center w-100"
                                        style="width:100%;margin-left: 0%;margin-top: 0%;margin-bottom: 3%;">
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            <div class="bg-white d-none d-md-block" style="width: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Qualification et validation des besoins avec le métier
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Planification et estimation du projet
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Mise en place de la méthodologie agile pour le projet
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Animation et participation aux réunions de comitologie (Daily, Démo)
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="bg_white_content_container">
                                    <p class="bg_white_content_header h4">
                                        Priorisation des travaux du centre de services Data</p>
                                    <div class="d-flex align-items-center w-100"
                                        style="width:100%;margin-left: 0%;margin-top: 0%;margin-bottom: 3%;">
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            <div class="bg-white d-none d-md-block" style="width: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Évolution et mise à jour des cubes SSAS (Tabulaire) et
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Migration des tableaux de bords de Power BI vers Tableau Software
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="bg_white_content_container">
                                    <p class="bg_white_content_header h4">
                                        Construction de la documentation utilisateur</p>
                                </div>
                                <div class="bg_white_content_container">
                                    <p class="bg_white_content_header h4">
                                        Recette et formation utilisateur</p>
                                </div>
