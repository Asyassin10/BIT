                        ...
                        <div class="app_d_v_header_container  mx-0 px-0 row w-100 d-flex align-items-center tout_nos_services_container"
                            ...
                            <div class=" col-12 col-md-7 tout_nos_services_child_a" id="">
                                ...
                                <p style="text-align:left;margin-left: 10%;margin-right: 10%;width:80%;">
                                    Refonte et migration de l'application OUI.SNCF.
                                </p>
                            </div>
                            <div class="col-12 col-md-5 study_cases_image_header m-0 p-0" id="">
                                <img src="{{ secure_asset('images/blogimage/OUI.SNCF.webp') }}" class="m-0 p-0 w-100">
                            ...
                            <div
                                ...
                                <div class="w-100 w-md-50  content_centered">
                                    ...
                                    <p class="text-left my-4 " style="padding-top: 3%;">
                                        OUI.sncf, anciennement Voyages-sncf.com, est devenu une
                                        référence incontournable dans le domaine du transport.
                                    </p>
                                    <p class="text-left mt-2">
                                        La plateforme OUI.sncf offre un accès à toutes les offres de mobilité et de services
                                        de la SNCF, avec d'un côté les TGV InOUI, proposant une expérience de voyage haut
                                        de gamme, et de l'autre OUlgo, offrant des trajets grande vitesse à des tarifs
                                        avantageux. Avec 14 millions de visiteurs uniques par mois, OUI.sncf est devenu un
                                        site incontournable pour les utilisateurs à la recherche de solutions de voyage.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class=" row   tout_nos_services_container " id=""
                            ...
                            <div class="col-md-9 div_content_container">
                                ...
                                <h3 class="text-white mb-4" style="margin-left: 5%;">Nos réalisations et méthodologie
                                    adoptée :</h3>
                                <p class="text-white" style="margin-left: 5%;">Au sein de la direction des systèmes
                                    d'information de OUI.sncf, notre
                                    équipe d'experts a contribué aux réalisations suivantes :
                                </p>
                                <div class="bg_white_content_container">
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;" >
                                                <div class="d-flex align-items-center mt-2 mx-4  w-100" style="height: 100%">
                                                    <p class="w-100">
                                                        Automatisation du pipeline de déploiement et création d'un dashboard de  monitoring
