                    ...
                    <section style="width: 100%;heigt:10%;" id=""
                        ...
                        <div class="app_d_v_header_container  mx-0 px-0 row w-100 d-flex align-items-center tout_nos_services_container"
                            ...
                            <div class=" col-12 col-md-7 tout_nos_services_child_a" id="">
                                ...
                                <p style="text-align:left;margin-left: 10%;margin-right: 10%;width:80%;">
                                    Migration de l'infrastructure Edenred Amérique Latine (DXC, IBM) vers
                                    Azure.
                                </p>
                            </div>
                            <div class="col-12 col-md-5 study_cases_image_header m-0 p-0" id="">
                                <img src="{{ secure_asset('images/blogimage/Edenred.webp') }}" class="m-0 p-0 w-100">
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div class="w-100 w-md-50  content_centered">
                                    ...
                                    <p class="text-left my-4 " style="padding-top: 3%;">
                                        Notre intervention chez Edenred avait pour objectifs principaux :
                                    </p>
                                    <ul class="list_style_app_unorder">
                                        <li><span class="text-dark">Définir la gouvernance Cloud;</span>
                                        </li>
                                        <li><span class="text-dark">Migrer les applications hébergées en Data Center avant
                                                la fin des
                                                contrats d'hébergement et de support des baies de stockage.</span></li>

                                    </ul>
                                    <p class="text-left" style="padding-top: 5%;">
                                        L'infrastructure source d'Edenred reposait sur une architecture en étoile avec
                                        plusieurs contrôleurs de domaine Active Directory répartis sur 90 sites dans le
                                        monde. Notre projet avait pour objectif de migrer tous les workloads avant la fin de
                                        l'année 2020, afin de ne pas renouveler les contrats d'hébergement.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class=" row   tout_nos_services_container " id=""
                            ...
                            <div class="col-md-2 d-flex justify-content-center display_only_on_mobile">
                                <div class="vertical-line p-0 m-0" style="height:72%;">
                                    <div class="vertical-line_part" style="top: 14%;"></div>
                            ...
                            <div class="col-md-9 div_content_container">
                                ...
                                <div class="bg_white_content_container">
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        style="width:100%;margin-left: 0%;padding-top: 8%;margin-bottom: 3%;">
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Assessment du portefeuille applicatif à migrer
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Définition de la stratégie de migration vers le cloud Azure
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Élaboration du Plan de Reprise d'Activité (DRP) et du Plan de
                                                        Reprise Technique (DRT)
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Mise en place de l'architecture hybride
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Définition de la gouvernance Cloud (RACI, TOM, ...)
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Mise en place des comités d'architecture
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p class="w-100">
                                                        Automatisation du provisioning laas/PaaS/SaaS pour prévenir les
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p class="w-100">
                                                        Formation des Business Units (BU) et partage des bonnes pratiques
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p class="w-100">
                                                        Mise en place du monitoring technique et fonctionnel centralisé
