                        ...
                        <div class="app_d_v_header_container  mx-0 px-0 row w-100 d-flex align-items-center tout_nos_services_container"
                            ...
                            <div class=" col-12 col-md-7 tout_nos_services_child_a" id="">
                                ...
                                <p style="text-align:left;margin-left: 10%;margin-right: 10%;width:80%;">
                                    Accompagnement à la maîtrise d’ouvrage dans la mise en place d’une plateforme d’échange
                                    de données médicales. </p>
                            </div>
                            <div class="col-12 col-md-5 study_cases_image_header m-0 p-0" id="">
                                <img src="{{ secure_asset('images/blogimage/Servier.webp') }}" class="m-0 p-0 w-100">
                            ...
                            <div
                                ...
                                <div class="w-100 w-md-50  content_centered">
                                    ...
                                    <p class="text-left my-4 " style="padding-top: 3%;">
                                        Servier, un groupe pharmaceutique, souhaite mettre en place une nouvelle gouvernance
                                        des données et moderniser son infrastructure informatique. Dans sa feuille de route,
                                        le groupe prévoit des chantiers concernant le stockage et l’analyse des données.
                                    </p>
                                    <p class="text-left mt-2">
                                        Pour soutenir ses projets en matière d’intelligence artificielle, Servier ambitionne
                                        de créer une « plateforme data Groupe » de pointe.
                                        BTI-Advisory, en collaboration avec Infogene, a accompagné Servier dans la création
                                        d’une solution middle-ware permettant l’ingestion sécurisée et le partage des
                                        données médicales
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-9 div_content_container">
                                ...
                                <div class="bg_white_content_container">
                                    <p class="bg_white_content_header h4">
                                        Inventaire des livrables sur le portail SYNAPS pour les développement Talend </p>
                                ...
                                <div class="bg_white_content_container">
                                    <p class="bg_white_content_header h4">
                                        Simplification de documents types</p>
                                    <div class="d-flex align-items-center w-100"
                                        style="width:100%;margin-left: 0%;margin-top: 0%;margin-bottom: 3%;">
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            <div class="bg-white d-none d-md-block" style="width: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Organisation d’ateliers avec les experts métiers tels que les
                                                        architectes, les équipes projets et centre de service Capgemini
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Définition d’une typologie de templates, incluant les contrats
                                                        d’interface, les spécifications générales (Global design
                                                        specification), les spécifications détaillées (Detail Design
                                                        specification) et les Pivots
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Rédaction des templates en anglais
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Diffusion des nouveaux templates aux différents acteurs de la
                                                        plateforme (Servier France et filiales à l’étranger) et
                                ...
                                <div class="bg_white_content_container">
                                    <p class="bg_white_content_header h4">
                                        Mise en place des processus de gestion de la demande et de mise à jour de la gestion
                                        documentaire</p>
                                    <div class="d-flex align-items-center w-100"
                                        style="width:100%;margin-left: 0%;margin-top: 0%;margin-bottom: 3%;">
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Clarification du RACI (Responsibility Assignment Matrix) dans le
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Élaboration sur logigramme pour les processus de gestion de la
                                                        demande, gestion des configurations et stockage des fichiers sur le
                                                        SharePoint </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Définition de micro-processus sur le macro-chiffrage des
                                                        spécifications générales </p>
                                                </div>
                                            </div>
                                        </div>
