                    ...
                    <section style="width: 100%;heigt:10%;" id=""
                        ...
                        <div class="app_d_v_header_container  mx-0 px-0 row w-100 d-flex align-items-center tout_nos_services_container"
                            ...
                            <div class=" col-12 col-md-7 tout_nos_services_child_a" id="">
                                ...
                                <p style="text-align:left;margin-left: 10%;margin-right: 10%;width:80%;">
                                    Refonte du produit Prévoyance TNS.
                                </p>
                            </div>
                            <div class="col-12 col-md-5 study_cases_image_header m-0 p-0" id="">
                                <img src="{{ secure_asset('images/blogimage/Entoria.webp') }}" class="m-0 p-0 w-100">
                            ...
                            <div
                                ...
                                <div class="w-100 w-md-50  content_centered">
                                    ...
                                    <p class="text-left my-4 " style="padding-top: 3%;">
                                        Entoria est un acteur majeur du courtage en assurance de
                                        personnes, spécialisé dans les domaines de la santé, de la
                                        prévoyance et de l'assurance de biens
                                    </p>
                                    <p class="text-left mt-2">
                                        En tant que partenaire assurance des entrepreneurs, Entoria propose des solutions
                                        d'assurance adaptées aux travailleurs non-salariés (TNS) pour les protéger en cas
                                        d'incapacité, d'invalidité et de décès. Le produit de prévoyance TNS offre une
                                        approche forfaitaire sous conditions, avec une sélection médicale simplifiée, quel
                                        que soit le métier ou le statut professionnel du souscripteur.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class=" row   tout_nos_services_container " id=""
                            ...
                            <div class="col-md-2 d-flex justify-content-center display_only_on_mobile">
                                <div class="vertical-line p-0 m-0" style="height:67%;">
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Développement du backoffice de paramétrage (VueJS)
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Développement de la plateforme API exposant les données de référentiels (MongoDB)
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Migration du paramétrage des offres mobile et fixe des référentiels de données Legacy
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        Lancement d'un pilote avec les équipes de paramétrage pour un déploiement progressif
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center w-100"
                                        ...
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p class="w-100">
                                                        Conception d'un nouvel outil de paramétrage des offres médicales. Cet outil offre une
                                                        meilleure ergonomie, des processus de paramétrage efficaces et une adaptation aux
                                                        nouveaux parcours digitaux. L'internalisation de l'outil a également permis de réduire
                                                        significativement les coûts de maintenance et de support (TMA)
