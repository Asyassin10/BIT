                    ...
                    <section style="width: 100%;heigt:10%;" id=""
                        ...
                        <div class="app_d_v_header_container  mx-0 px-0 row w-100 d-flex align-items-center tout_nos_services_container"
                            ...
                            <div class="col-12 col-md-5 study_cases_image_header m-0 p-0" id="">
                                <img src="{{ asset('images/blogimage/Disneyland Paris.webp') }}" class="m-0 p-0 w-100">
                            ...
                            <div
                                ...
                                <div class="w-50">
                                    ...
                                    <p class="text-left my-4 " style="padding-top: 3%;">
                                        En 2018, Disneyland Paris a lancé un plan d’investissement majeur visant à
                                        moderniser son système d’information (SI) en vue d’améliorer plusieurs aspects clés
                                        de son fonctionnement. Ce plan comprenait notamment une meilleure connaissance des
                                        objectifs métiers et du patrimoine SI, une amélioration significative de la
                                        cohérence, de la qualité et de la circulation des informations, ainsi qu’une
                                        réduction de la complexité et de l’effet « plat de spaghetti » au niveau des
                                        architectures.
                                    </p>
                                    <p class="text-left mt-2">
                                        Afin de donner vie à cette mission, une attention particulière a été portée au
                                        renforcement de la cellule d’architecture et à la définition de nouveaux objectifs
                                        pour les acteurs du changement, tels que faciliter la création de nouveaux services,
                                        améliorer la satisfaction client liée aux services de la Direction des Systèmes
                                        d’Information (DSI), optimiser la fluidité, la fiabilité, la mise en conformité des
                                        processus, prévenir les risques, détecter, traiter et tracer les incidents, et
                            ...
                            <div class="col-md-9 div_content_container">
                                ...
                                <div class="bg_white_content_container">
                                    <p class="bg_white_content_header h4">
                                        Afin de réaliser ces missions, nous avons contribuer aux activités suivantes : </p>
                                    <div class="d-flex align-items-center w-100"
                                        style="width:100%;margin-left: 0%;margin-top: 0%;margin-bottom: 3%;">
                                        <div class="d-flex  w-100 " style=" margin-left: 5%;">
                                            <div class="bg-white d-none d-md-block" style="width: 5%;">
                                            ...
                                            <div class="" style="width: 90%;">
                                                <div class="d-flex align-items-center mt-2 mx-4" style="height: 100%">
                                                    <p>
                                                        ...
                                                        Techniques pour réaliser les DAT (Dossier d’Architecte Technique)
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
