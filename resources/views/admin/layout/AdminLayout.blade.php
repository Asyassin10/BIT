                    ...
                    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        ...
                        <ul class="chat-list">
                            <li class="list active">
                                <div class="profile"><img src="{{ asset('melody/images/faces/face1.jpg') }}"
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ asset('melody/images/faces/face2.jpg') }}"
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ asset('melody/images/faces/face3.jpg') }}"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                                    <p>Daniel Russell</p>
                                    <p>Available</p>
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ asset('melody/images/faces/face5.jpg') }}"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img src="{{ asset('melody/images/faces/face6.jpg') }}"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                                    <p>Sarah Graves</p>
                                    <p>Available</p>
                                        ...
                                        <li>
                                            ...
                                            <div class="image-layers">
                                                ...
                                                <img class="img-sm rounded-circle image-layer-item"
                                                    src="{{ asset('melody/images/faces/face3.jpg') }}"
                                                    alt="profile" />
                                                <img class="img-sm rounded-circle image-layer-item"
                                                    src="{{ asset('melody/images/faces/face5.jpg') }}"
                                                    alt="profile" />
                                                <img class="img-sm rounded-circle image-layer-item"
                                                    src="{{ asset('melody/images/faces/face8.jpg') }}"
                                                    alt="profile" />
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="py-1">
                                                        <img src="{{ asset('melody/images/faces/face13.jpg') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="py-1">
                                                        <img src="{{ asset('melody/images/faces/face11.html') }}"
                                                            alt="profile" class="img-sm rounded-circle" />
                                                    </td>
                                                    <td class="font-weight-bold">
                                                        Marguerite Phillips
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="{{ asset('melody/images/faces/face1.jpg') }}"
                                                            alt="profile" class="img-sm rounded-circle" />
                                                    </td>
                                                    <td>
                                                        South Shyanne
                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="{{ asset('melody/images/faces/face3.jpg') }}"
                                                            alt="profile" class="img-sm rounded-circle" />
                                                    </td>
                                                    <td>
                                                        East Helga
                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="{{ asset('melody/images/faces/face4.jpg') }}"
                                                            alt="profile" class="img-sm rounded-circle" />
                                                    </td>
                                                    <td>
                                                        Omerbury
