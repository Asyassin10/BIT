...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                                                                            <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="/assets/admin/img/logo.svg" alt="Logo Icon">
        ...
        <form action="{{ url('/admin/dashboard') }}" method="get">
            <input type="hidden" name="_token" value="5s9mLfEkDNsbNcHfhNniptsTAZWHTMCy97qPtb9s">
            ...
            <div class="form-group" id="rememberMeGroup">
                <div class="controls">
                    <input type="checkbox" name="remember" id="remember" value="1"><label for="remember"
                        class="remember-me-text">souviens-toi de moi</label>
                </div>
            </div>
