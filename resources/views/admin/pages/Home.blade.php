                                ...
                                <li>
                                    ...
                                    <div class="image-layers">
                                        ...
                                        <img class="img-sm rounded-circle image-layer-item"
                                            src="{{ asset('melody/images/faces/face3.jpg') }}" alt="profile" />
                                        <img class="img-sm rounded-circle image-layer-item"
                                            src="{{ asset('melody/images/faces/face5.jpg') }}" alt="profile" />
                                        <img class="img-sm rounded-circle image-layer-item"
                                            src="{{ asset('melody/images/faces/face8.jpg') }}" alt="profile" />
                                    </div>
                                </li>
                                <li>
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-1">
                                                <div class="img-sm rounded-circle bg-warning profile-image-text">
                                                    M</div>
                                            </td>
                                            <td class="font-weight-bold">
                                                Manuel Yates
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-1">
                                                <img src="{{ asset('melody/images/faces/face11.html') }}" alt="profile"
                                                    class="img-sm rounded-circle" />
                                            </td>
                                            <td class="font-weight-bold">
                                                Marguerite Phillips
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="py-1">
                                                <img src="{{ asset('melody/images/faces/face1.jpg') }}" alt="profile"
                                                    class="img-sm rounded-circle" />
                                            </td>
                                            <td>
                                                South Shyanne
                                        ...
                                        <tr>
                                            <td class="py-1">
                                                <img src="{{ asset('melody/images/faces/face3.jpg') }}" alt="profile"
                                                    class="img-sm rounded-circle" />
                                            </td>
                                            <td>
                                                East Helga
                                        ...
                                        <tr>
                                            <td class="py-1">
                                                <img src="{{ asset('melody/images/faces/face4.jpg') }}" alt="profile"
                                                    class="img-sm rounded-circle" />
                                            </td>
                                            <td>
                                                Omerbury
