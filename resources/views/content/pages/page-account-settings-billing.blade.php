                        ...
                        <div class="col-lg-6">
                            <form id="creditCardForm" class="row gx-2 gy-1 validate-form" onsubmit="return false">
                                ...
                                <div class="col-6 col-md-3">
                                    ...
                                    <input type="text" id="addCardCvv" class="form-control add-cvv-code-mask"
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check-label fw-bolder" for="addSaveCard"> Save Card for future
                                            billing? </label>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" id="companyName" name="companyName" class="form-control"
                                    placeholder="PIXINVENT" data-msg="Please enter company name" />
                            </div>
                            <div class="mb-1 col-md-6">
                                ...
                                <input class="form-control" type="text" id="billingEmail" name="billingEmail"
                                    placeholder="john.doe@example.com" data-msg="Please enter billing email" />
                            </div>
                            <div class="mb-1 col-md-6">
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <input class="form-control account-number-mask" type="text" id="mobileNumber"
                            ...
                            <div class="mb-1 col-md-6">
                                ...
                                <input type="text" class="form-control account-zip-code" id="zipCode"
                                    name="zipCode" placeholder="Enter Zip Code" maxlength="6" />
                            </div>
                        </div>
