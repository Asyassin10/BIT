            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="{{ secure_asset('page/blog/detail') }}"
                                class="blog-title-truncate text-body-heading">The Best Features Coming to iOS and Web
                                design</a>
                        </h4>
                        <div class="d-flex">
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="{{ secure_asset('page/blog/detail') }}"
                                class="blog-title-truncate text-body-heading">Latest Quirky Opening Sentence or
                                Paragraph</a>
                        </h4>
                        <div class="d-flex">
                            <div class="avatar me-50">
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="{{ secure_asset('page/blog/detail') }}"
                                class="blog-title-truncate text-body-heading">Share an Amazing and Shocking Fact or
                                Statistic</a>
                        </h4>
                        <div class="d-flex">
                            <div class="avatar me-50">
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="{{ secure_asset('page/blog/detail') }}"
                                class="blog-title-truncate text-body-heading">Ships at a distance have Every Man’s Wish on
                                Board</a>
                        </h4>
                        <div class="d-flex">
                            <div class="avatar me-50">
                        ...
                        <p class="card-text blog-content-truncate">
                            A little personality goes a long way, especially on a business blog. So don’t be afraid to let
                            loose.
                        </p>
                        <hr />
                        <div class="d-flex justify-content-between align-items-center">
