                ...
                <div class="col-md-5 order-md-0 order-1">
                    <div class="card-body">
                        ...
                        <form id="createApiForm" onsubmit="return false">
                            <div class="mb-2">
                                <label for="ApiKeyType" class="form-label">Choose the Api key type you want to
                                    create</label>
                            ...
                            <div class="mb-2">
                                ...
                                <input class="form-control" type="text" name="apiKeyName" placeholder="Server Key 1"
                ...
                <div class="row gy-2">
                    ...
                    <div class="col-12">
                        <div class="bg-light-secondary position-relative rounded p-2">
                            <div class="dropdown dropstart btn-pinned">
                                <a class="btn btn-icon rounded-circle hide-arrow dropdown-toggle p-0"
                                    href="javascript:void(0)" id="dropdownMenuButton3" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <i data-feather="more-vertical" class="font-medium-4"></i>
                                </a>
