        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                ...
                <ul class="nav nav-pills mb-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ secure_asset('app/user/view/billing') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ secure_asset('app/user/view/connections') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex mt-2">
                            <div class="flex-shrink-0">
                                <img src="{{ secure_asset('images/icons/social/google.png') }}" alt="google" class="me-1"
                                    height="38" width="38" />
                            </div>
                        ...
                        <div class="d-flex mt-2">
                            <div class="flex-shrink-0">
                                <img src="{{ secure_asset('images/icons/social/slack.png') }}" alt="slack" class="me-1"
                                    height="38" width="38" />
                            </div>
                            <div class="d-flex align-item-center justify-content-between flex-grow-1">
                                <div class="me-1">
                        ...
                        <div class="d-flex mt-2">
                            <div class="flex-shrink-0">
                                <img src="{{ secure_asset('images/icons/social/github.png') }}" alt="github" class="me-1"
                                    height="38" width="38" />
                            </div>
                            <div class="d-flex align-item-center justify-content-between flex-grow-1">
                                <div class="me-1">
                        ...
                        <div class="d-flex mt-2">
                            <div class="flex-shrink-0">
                                <img src="{{ secure_asset('images/icons/social/mailchimp.png') }}" alt="mailchimp"
                        ...
                        <div class="d-flex mt-2">
                            <div class="flex-shrink-0">
                                <img src="{{ secure_asset('images/icons/social/asana.png') }}" alt="asana" class="me-1"
                                    height="38" width="38" />
                            </div>
                            <div class="d-flex align-item-center justify-content-between flex-grow-1">
                                <div class="me-1">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex mt-2">
                            <div class="flex-shrink-0">
                                <img src="{{ secure_asset('images/icons/social/facebook.png') }}" alt="facebook" class="me-1"
                                    height="38" width="38" />
                            </div>
                        ...
                        <div class="d-flex align-items-start mt-2">
                            <div class="flex-shrink-0">
                                <img src="{{ secure_asset('images/icons/social/twitter.png') }}" alt="twitter" class="me-1"
                                    height="38" width="38" />
                            </div>
                            <div class="d-flex justify-content-between flex-grow-1">
                                <div class="me-1">
                        ...
                        <div class="d-flex mt-2">
                            <div class="flex-shrink-0">
                                <img src="{{ secure_asset('images/icons/social/linkedin.png') }}" alt="instagram"
                                    class="me-1" height="38" width="38" />
                            </div>
                            <div class="d-flex justify-content-between flex-grow-1">
                                <div class="me-1">
                        ...
                        <div class="d-flex mt-2">
                            <div class="flex-shrink-0">
                                <img src="{{ secure_asset('images/icons/social/dribbble.png') }}" alt="dribbble" class="me-1"
                                    height="38" width="38" />
                            </div>
                            <div class="d-flex justify-content-between flex-grow-1">
                                <div class="me-1">
                        ...
                        <div class="d-flex mt-2">
                            <div class="flex-shrink-0">
                                <img src="{{ secure_asset('images/icons/social/behance.png') }}" alt="behance" class="me-1"
                                    height="38" width="38" />
                            </div>
                            <div class="d-flex justify-content-between flex-grow-1">
                                <div class="me-1">
